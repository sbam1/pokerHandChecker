...
public class TwoPairsTest {
    ...
    private PokerHand createPokerHandWithTwoPair() {
    ...
    private PokerHand createPokerHandWithSameTwoPairWithBoth() {
        Card card1 = new Card(CardCategory.CLUBS, CardNumber.ACE);
    ...
    private PokerHand createPokerHandWithSameTwoPairTie() {
        Card card1 = new Card(CardCategory.CLUBS, CardNumber.ACE);
